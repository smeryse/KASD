...
namespace Task8.Collections
{
    public class MyArrayList<T>
    {
        ...
        #region Private helper methods (EnsureCapacity, CheckIndex, CheckIndexForAdd)
        ...
        #region Public operations (Add, AddAll, Clear, Contains, ContainsAll, IsEmpty, Remove, RemoveAll, RetainAll)
        ...
        #region Public accessors and converters (Size, ToArray, Get, Set, IndexOf, LastIndexOf, RemoveAt, SubList)
        ...
        #region Index methods (Add at index, AddAll at index)
