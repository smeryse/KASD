...
namespace ЛР5
{
    class Program
    {
        ...
        static void SubscribeToStudentErrors()
        {
            foreach (var student in institute.Courses
        ...
        {
            Console.WriteLine($"\n[Ошибка студента] {sender.GetType().Name}: {e.Exception.GetType().Name} - {e.Message}");
        }
        ...
        static void MainMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine("7. Запустить тесты с ошибками");
