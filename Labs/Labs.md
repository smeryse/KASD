...
| 3 | [FileDirectoryIO](Labs/03-FileDirectoryIO) | File and directory operations using File, Directory, FileInfo, DirectoryInfo, and FileStream | ✅ |  |
| 4 | [DelegatesAndInterfaces](Labs/04-DelegatesAndInterfaces) | Interfaces and delegates in C# | ✅ | 3 |
...
```bash
# Navigate to lab folder and run
